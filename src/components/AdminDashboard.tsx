        ...
        <div className="max-w-8xl mx-auto">
          <div className="bg-white rounded-lg shadow-md p-6 mb-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              <form onSubmit={(e) => assignCase(e, title, location, market, caseInfo, workOrder, selectedUser, setTitle, setSelectedUser, filteredUsers, fetchData, setErrorMessage, currentUser, userType, installDate, setInstallDate, setSearch, toast)} className="space-y-4 rounded-lg shadow-md p-4">
                <div>
