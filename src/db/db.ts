export const status = [
  ...
  { name: "INSPECTION ✅", id: 2.2, colorMap: "bg-purple-300 text-black hover:bg-purple-600", colorStatus: "bg-purple-500/70 text-black hover:bg-purple-900" }, 
